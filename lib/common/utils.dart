...
class Utils {
      ...
      Get.generalDialog(
        ...
        transitionBuilder: (context, a1, a2, widget) {
          return StatefulBuilder(
            builder:
                (context, setState) => Transform.scale(
                  scale: a1.value,
                  child: Opacity(
                    opacity: a1.value,
                    child: Container(
                      ...
                      child: WillPopScope(
                        ...
                        child: LoadingAnimationWidget.flickr(
                          leftDotColor: CustomColors.primaryColorDark,
                          rightDotColor: CustomColors.primaryColor,
                          size: 50,
                        ),
                      ),
                    ),
  ...
  static Future<String> getDeviceDetails() async {
    ...
    if (Platform.isIOS) {
      ...
      // log(androidDeviceInfo.version.);
      return data; // unique ID on Android
    }
  }
