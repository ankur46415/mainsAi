...
class _ObjectiveTestNameState extends State<ObjectiveTestName> {
  ...
  void initState() {
    ...
    if (arguments != null && arguments is AiTestItem) {
      ...
      print('⚠️ Using default testData: ${testData.name}');
    }
  }
                ...
                child: CircleAvatar(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      try {
                        Get.offAllNamed(
                          AppRoutes.mainNav, // <-- use the new route!
                  ...
                  children: [
                    ...
                    GetBuilder<ObjectiveRestNameController>(
                      ...
                      builder: (controller) {
                        ...
                        return Column(
                          children: [
                            // Show Start Test button only if user hasn't reached max attempts
                                ...
                                children: List.generate(history.length, (
                                  ...
                                  return Card(
                                    ...
                                    child: InkWell(
                                      borderRadius: BorderRadius.circular(12),
                                      onTap: () {
                                        // Navigate to ResultOfAttemptTest with testId
                                        Get.to(
                                          () => ResultOfAttemptTest(
                                            attempt: attempt,
  ...
  Widget _buildImageWidget() {
    ...
    if (testData.imageUrl.isEmpty || !testData.imageUrl.startsWith('http')) {
      return Image.asset('assets/images/book2.jpg', fit: BoxFit.cover);
    }
    ...
    return CachedNetworkImage(
      ...
      errorWidget:
          (context, url, error) =>
              Image.asset('assets/images/book2.jpg', fit: BoxFit.cover),
    );
  }
