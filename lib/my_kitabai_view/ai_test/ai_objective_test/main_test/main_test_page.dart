...
class _MainTestForAiTestState extends State<MainTestForAiTest> {
  ...
  void _initializeTestData() {
    try {
      ...
      if (arguments is AiTestItem) {
        ...
        // Handle Map with testId and testData
  ...
  void _handleError(String message) {
    ...
    print('❌ Error in MainTestForAiTest: $message');
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.grid_view, color: Colors.red[700], size: 24),
                      ],
                    ),
                  ),
                  Divider(thickness: 1, color: Colors.grey[300]),
                        ...
                        child: Padding(
                          ...
                          child: Wrap(
                            ...
                            children: List.generate(
                              ...
                              (index) {
                                String status = controller.getQuestionStatus(
                                  index,
                                );
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Spacer(),
                          Obx(() {
                            String status = controller.getQuestionStatus(index);
                            return Container(
                              padding: EdgeInsets.symmetric(
                                horizontal: 12,
                                vertical: 6,
                            ...
                            return Card(
                              ...
                              child: RadioListTile<int>(
                                ...
                                onChanged: (value) {
                                  ...
                                  controller.selectedAnswers.refresh();
                                },
  ...
  Widget _legendBox(String label, Color color, int count) {
    return Container(
